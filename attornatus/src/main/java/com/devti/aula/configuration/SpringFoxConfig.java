...
public class SpringFoxConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("API para persistencia de cadastro de pessoas")
				.description("Esta é para o teste técino em Back/Java - Attornatus - https://attornatus.gupy.io/ ")
				.version("1.0.0")
